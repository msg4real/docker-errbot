...
RUN cd /srv/errbackends && git clone https://github.com/errbotio/err-backend-slackv3 && pip install --no-cache-dir -r /srv/errbackends/err-backend-slackv3/requirements.txt
